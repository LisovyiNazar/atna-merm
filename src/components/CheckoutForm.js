...
function CheckoutForm() {
    ...
    async function handlePay(e) {
        ...
        setPaying(true);
        const { client_secret } = await fetch("https://atna-menr-api.onrender.com/create-payment", {
            method: "POST",
            headers: {
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="Імʼя" value={user.name} disabled />
                        </Form.Group>
                    </Col>
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            <Form.Label>Електронна адреса</Form.Label>
                            <Form.Control type="text" placeholder="Електронна адреса" value={user.email} disabled />
                        </Form.Group>
                    </Col>
                </Row>
                <Row>
