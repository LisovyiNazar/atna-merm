                                    ...
                                    {user.isAdmin && (
                                        <>
                                            <LinkContainer to="/admin">
                                                <NavDropdown.Item>Інформаційна Панель</NavDropdown.Item>
                                            </LinkContainer>
                                            <LinkContainer to="/new-product">
                                                <NavDropdown.Item>Створити Продукт</NavDropdown.Item>
                                            </LinkContainer>
                                        </>
                                    )}
                                    {!user.isAdmin && (
                                        <>
                                            ...
                                            <LinkContainer to="/orders">
                                                <NavDropdown.Item>Мої замовлення</NavDropdown.Item>
                                            </LinkContainer>
                                        </>
                                    )}
